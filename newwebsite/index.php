...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="color-switcher/js/style-customizer/css/style-customizer.css">
    <link rel="stylesheet/less" type="text/css" href="color-switcher/less/skin.less">
...
<section id="home" class="cursor-light p-0">
        ...
        <div id="rev_slider_19_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
            <ul>
                ...
                <li data-index="rs-1" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/slide-img1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="images/slider-image1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 16px; line-height: 20px; font-weight: 300; color: #ffffff; letter-spacing: 0px;font-family:Roboto;"><p class="text-white"> </p></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 40px; line-height: 50px; font-weight: 500; color: #ffffff; letter-spacing: 0px;font-family:Poppins;">Bridging the gap between</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; white-space: nowrap; font-size: 40px; line-height: 50px; font-weight: 200; color: #ffffff; letter-spacing: 0px;font-family:Poppins;">Academia and Industry</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 8; min-width: 601px; max-width: 601px; white-space: normal; font-size: 16px; line-height: 22px; font-weight: 300; color: #ffffff; letter-spacing: 0px;font-family:Roboto;"><p class="text-white">Uppskale is a HR Tech startup where we strive to bring in progressive technology to bridge the gap between academia and industry</p></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9; letter-spacing: .5px;"><a class="btn btn-large btn-rounded btn-white" href="#offerings">Learn More</a></div>
                    ...
                    <div class="tp-caption d-none d-lg-block tp-resizeme rs-parallaxlevel-1"
                         ...
                         style="z-index: 10;">
                        <div class="rs-looped rs-wave"  data-speed="10" data-angle="0" data-radius="5px" data-origin="50% 50%"><img src="images/object1.png" alt="" data-ww="['576px','530px','462px','462px']" data-hh="['566px','530px','454px','454px']" data-no-retina> </div></div>
                    ...
                    <div class="tp-caption d-none d-lg-block tp-resizeme rs-parallaxlevel-2"
                        ...
                        <div class="rs-looped rs-wave"  data-speed="20" data-angle="0" data-radius="8px" data-origin="50% 50%">
                            <svg width="500" height="495">
                                ...
                                <image clip-path="url(#clipPolygon)" height="100%" width="100%" xlink:href="images/svg-image1.jpg" />
                            </svg>
                        </div>
                ...
                <li data-index="rs-2" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/slide-img2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="images/slider-image2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 30px; line-height: 35px; font-weight: 600; color: #ffffff; letter-spacing: 0px;font-family:Poppins;">Creative Onepage </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; min-width: 500px; max-width: 500px; white-space: normal; font-size: 18px; line-height: 22px; font-weight: 300; color: #ffffff; letter-spacing: 1px;font-family:Roboto;"><p class="text-white">Curabitur mollis bibendum luctus. Duis suscipit </p></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9; letter-spacing: .5px;"><a class="btn btn-large btn-rounded btn-transparent-white" href="javascript:void(0);">Learn More</a></div>
                ...
                <li data-index="rs-3" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/slide-img2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 16px; line-height: 20px; font-weight: 300; color: #ffffff; letter-spacing: 0px;font-family:Roboto;"><p class="text-white">Lorem ipsum dolor sit amet purus.  </p></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 40px; line-height: 50px; font-weight: 500; color: #ffffff; letter-spacing: 0px;font-family:Poppins;">Web Design Agency </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; white-space: nowrap; font-size: 40px; line-height: 50px; font-weight: 200; color: #ffffff; letter-spacing: 0px;font-family:Poppins;">Locatecd in NewYork USA </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 8; min-width: 601px; max-width: 601px; white-space: normal; font-size: 16px; line-height: 22px; font-weight: 300; color: #ffffff; letter-spacing: 0px;font-family:Roboto;"><p class="text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas mi, vel dapibus diam. Mauris malesuada, nisl non rutrum commodo, sem magna. </p></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9; letter-spacing: .5px;"><a class="btn btn-large btn-rounded btn-white" href="javascript:void(0);">Learn More</a></div>
    ...
    <div class="slider-social">
        <ul class="list-unstyled">
            <li class="animated-wrap"><a class="animated-element" href="https://www.facebook.com/uppskale/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            <li class="animated-wrap"><a class="animated-element" href="https://www.linkedin.com/company/uppskale/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
            <li class="animated-wrap"><a class="animated-element" href="https://www.instagram.com/uppskale/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
        </ul>
    </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center wow fadeIn">
            ...
            <div class="col-md-6 mb-4">
                    <p>Uppskale is a HR Tech startup where we strive to bring in progressive technology to bridge the gap between academia and industry.<Br>
Functioning both online and offline, our distinctive approach helps both students and companies find the right fit for each other.
 </p>
                </div>
        </div>
        <?php if(1==2){ ?>
            ...
            <div class="col-md-12">
                <div class="laptop-img wow fadeInUp">
                    ...
                    <div id="laptop-slide" class="owl-carousel owl-theme">
                        <div class="item">
                            <img src="images/laptop-slide-img1.jpg" alt="image">
                        </div>
                        <div class="item">
                            <img src="images/laptop-slide-img2.jpg" alt="image">
                        </div>
                        <div class="item">
                            <img src="images/laptop-slide-img3.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center wow fadeIn">
                <div class="title d-inline-block">
                    <h6 class="mb-3"></h6>
                    <h2 class="gradient-text1 mb-3">Our Offerings</h2>
                    <p></p>
                </div>
            </div>
        </div>
        ...
        <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat">
            ...
            <div class="cbp-item web-design graphic">
                <a href="images/work-1.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-1.jpg" alt="port-1">
                    </div>
            ...
            <div class="cbp-item seo marketing">
                <a href="images/work-2.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-2.jpg" alt="port-2">
                    </div>
                    <div class="cbp-caption-activeWrap"></div>
                    <div class="cbp-l-caption-alignCenter center-block">
                        <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item seo marketing">
                <a href="images/work-4.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-4.jpg" alt="port-4">
                    </div>
                    <div class="cbp-caption-activeWrap"></div>
                    <div class="cbp-l-caption-alignCenter center-block">
                        <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item graphic seo marketing">
                <a href="images/work-3.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-3.jpg" alt="port-3">
                    </div>
                    <div class="cbp-caption-activeWrap"></div>
                    <div class="cbp-l-caption-alignCenter center-block">
                        <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design graphic">
                <a href="images/work-5.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-5.jpg" alt="port-5">
                    </div>
                    <div class="cbp-caption-activeWrap"></div>
                    <div class="cbp-l-caption-alignCenter center-block">
                        <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item seo marketing graphic ">
                <a href="images/work-6.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-6.jpg" alt="port-6">
                    </div>
                    <div class="cbp-caption-activeWrap"></div>
                    <div class="cbp-l-caption-alignCenter center-block">
                        <div class="cbp-l-caption-body">
            ...
            <div class="cbp-item web-design seo">
                <a href="images/work-7.jpg" class="cbp-caption cbp-lightbox">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/work-7.jpg" alt="port-7">
                    </div>
                    <div class="cbp-caption-activeWrap"></div>
                    <div class="cbp-l-caption-alignCenter center-block">
                        <div class="cbp-l-caption-body">
            ...
            <div class="col-md-6 bg-light">
                <div id="testimonial_slider" class="owl-carousel">
                    ...
                    <div class="testimonial-image">
                        <img src="images/testimonial-img1.jpg" alt="image">
                    </div>
                    ...
                    <div class="testimonial-item item">
                        ...
                        <!--Image-->
                        <div class="testimonial-image">
                            <img src="images/testimonial-img2.jpg" alt="image">
                        </div>
                    ...
                    <div class="testimonial-item item">
                        ...
                        <!--Image-->
                        <div class="testimonial-image">
                            <img src="images/testimonial-img3.jpg" alt="image">
                        </div>
...
<?php } ?>
<!--Blog Start-->
<section id="student" class="bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center wow fadeIn">
                <div class="title d-inline-block">
...
<section id="company" class="cube-portfolio1">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center wow fadeIn">
                <div class="title d-inline-block">
            ...
            <div class="col-md-6 p-0">
                <div class="address-box title mb-0 bg-img4">
                    ...
                    <div class="address-text text-center text-white position-relative wow fadeInUp">
                        <h6 class="mb-3"></h6>
                        <!--title-->
                        <h2 class="mb-4">UppSkale</h2>
                        <!--Address-->
                        <p class="mb-3 text-white">11, Konark Society, Near Sundaram Complex, D-Cabin, Sabarmati<Br>Ahmedabad, Gujarat - 380019</p>
                        <!--Phone-->
                        <p class="mb-3 text-white">Office Telephone : +91 81411 66369, +91 94514 72589</p>
                        <!--Email-->
                        <p class="mb-3 text-white">mail : admin@uppskale.com</p>
                        <!--Timing-->
                        <p class="mb-3 text-white">Mon-Fri: 9am to 6pm</p>
                        <!--Social Icon-->
                        <div class="address-social">
                            <ul class="list-unstyled">
                                <li><a class="facebook-text-hvr" href="https://www.facebook.com/uppskale/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a class="linkedin-text-hvr" href="https://www.linkedin.com/company/uppskale/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                <li><a class="instagram-text-hvr" href="https://www.instagram.com/uppskale/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="footer-social">
                    <ul class="list-unstyled">
                        <li><a class="wow fadeInUp" href="https://www.facebook.com/uppskale/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        <li><a class="wow fadeInDown" href="https://www.linkedin.com/company/uppskale/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                        <li><a class="wow fadeInUp" href="https://www.instagram.com/uppskale/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        <li><a class="wow fadeInDown" href="mailto:admin@uppskale.com"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
                <p class="company-about fadeIn">© 2019 UppSkale. Made With Love By <a href="https://www.orivin.com" target="_new">Orivin Technologies</a></p>
            </div>
        </div>
    </div>
</section>
...
<!-- map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCAdXhVjZxxXVDh94RVwtUo9L_Q9T5-whg"></script>
<script src="js/map.js"></script>
<!-- Color Switcher -->
<script src="color-switcher/js/less/less.min.js" data-env="development"></script>
<script src="color-switcher/js/style-customizer/js/style-customizer.js"></script>
<!-- custom script -->
